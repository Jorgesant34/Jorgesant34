...
def TemaOscuro(*args):
    ...
    estilo_botones_borrar.configure('Botones_borrar.TButton', background="#000924", foreground="white")
    estilo_botones_borrar.map('Botones_borrar.TButton', background=[('active', '#000AB1')])
    estilo_botones_restantes.configure('Botones_restantes.TButton', background="#000924", foreground="white")
...
def TemaClaro(*args):
    ...
    estilo_botones_restantes.configure('Botones_restantes.TButton', relief="falt", background="#CECECE", foreground="black")
...
estilo_botones_restantes.configure('Botones_restantes.TButton', font="arial 22", width=5, relief="falt", background="#CECECE")
estilo_botones_restantes.map('Botones_restantes.TButton', background=[('active', '#858585')])
...
#Colocar los botones en pantalla
